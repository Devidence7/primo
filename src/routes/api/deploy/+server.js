...
const github = {
   ...
   * @returns {Promise<import('primo-builder/src/lib/deploy.js').DeploymentResponse>}
   */
 ...
 * @property {string} repo_name - The name of the repository where the files will be stored.
 * @property {Array<import('primo-builder/src/lib/deploy.js').File>} files - The files to be uploaded to the repo
